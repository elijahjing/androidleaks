...
import com.leak.sdk.leaklibrary.LeakWeakReference;
...
import static com.leak.sdk.leaklibrary.heap.AnalysisResult.failure;
import static com.leak.sdk.leaklibrary.heap.AnalysisResult.leakDetected;
import static com.leak.sdk.leaklibrary.heap.AnalysisResult.noLeak;
import static com.leak.sdk.leaklibrary.heap.AnalyzerProgressListener.Step.BUILDING_LEAK_TRACE;
import static com.leak.sdk.leaklibrary.heap.AnalyzerProgressListener.Step.COMPUTING_BITMAP_SIZE;
import static com.leak.sdk.leaklibrary.heap.AnalyzerProgressListener.Step.COMPUTING_DOMINATORS;
import static com.leak.sdk.leaklibrary.heap.AnalyzerProgressListener.Step.DEDUPLICATING_GC_ROOTS;
import static com.leak.sdk.leaklibrary.heap.AnalyzerProgressListener.Step.FINDING_LEAKING_REF;
import static com.leak.sdk.leaklibrary.heap.AnalyzerProgressListener.Step.FINDING_SHORTEST_PATH;
import static com.leak.sdk.leaklibrary.heap.AnalyzerProgressListener.Step.PARSING_HEAP_DUMP;
import static com.leak.sdk.leaklibrary.heap.AnalyzerProgressListener.Step.READING_HEAP_DUMP_FILE;
import static com.leak.sdk.leaklibrary.heap.HahaHelper.asString;
import static com.leak.sdk.leaklibrary.heap.HahaHelper.classInstanceValues;
import static com.leak.sdk.leaklibrary.heap.HahaHelper.extendsThread;
import static com.leak.sdk.leaklibrary.heap.HahaHelper.fieldValue;
import static com.leak.sdk.leaklibrary.heap.HahaHelper.hasField;
import static com.leak.sdk.leaklibrary.heap.HahaHelper.threadName;
import static com.leak.sdk.leaklibrary.heap.HahaHelper.valueAsString;
import static com.leak.sdk.leaklibrary.heap.LeakTraceElement.Holder.ARRAY;
import static com.leak.sdk.leaklibrary.heap.LeakTraceElement.Holder.CLASS;
import static com.leak.sdk.leaklibrary.heap.LeakTraceElement.Holder.OBJECT;
import static com.leak.sdk.leaklibrary.heap.LeakTraceElement.Holder.THREAD;
import static com.leak.sdk.leaklibrary.heap.LeakTraceElement.Type.ARRAY_ENTRY;
import static com.leak.sdk.leaklibrary.heap.LeakTraceElement.Type.INSTANCE_FIELD;
import static com.leak.sdk.leaklibrary.heap.LeakTraceElement.Type.STATIC_FIELD;
import static com.leak.sdk.leaklibrary.heap.Reachability.REACHABLE;
import static com.leak.sdk.leaklibrary.heap.Reachability.UNKNOWN;
import static com.leak.sdk.leaklibrary.heap.Reachability.UNREACHABLE;
...
public final class HeapAnalyzer {
  ...
  public List<TrackedReference> findTrackedReferences(File heapDumpFile) {
    ...
    try {
      ...
      ClassObj refClass = snapshot.findClass(LeakWeakReference.class.getName());
